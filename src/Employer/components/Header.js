        ...
        return (
            <div>
                <header className="main-header">
                    {/* Logo */}
                    <NavLink to="/employer" className="logo">
                        {/* mini logo for sidebar mini 50x50 pixels */}
                        <span className="logo-mini"><b>I</b>BD</span>
                        {/* logo for regular state and mobile devices */}
                        <span className="logo-lg"><b>Company Name |</b>Employer</span>
                    </NavLink>
                    {/* Header Navbar: style can be found in header.less */}
                    <nav className="navbar navbar-static-top">
                        {/* Sidebar toggle button*/}
                        <a href="/url_here" className="sidebar-toggle" data-toggle="push-menu" role="button">
                        ...
                        <div className="navbar-custom-menu">
                            <ul className="nav navbar-nav">
                                ...
                                <li className="dropdown messages-menu">
                                    <a href="/url_here" className="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <small><i className="fa fa-clock-o" /> 2 days</small>
                                        ...
                                        <li className="footer"><a href="/url_here">See All Messages</a></li>
                                    </ul>
                                </li>
                                ...
                                <li className="dropdown notifications-menu">
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <li className="footer"><a href="/url_here">View all</a></li>
                                    </ul>
                                </li>
                                ...
                                <li className="dropdown tasks-menu">
                                    ...
                                    <small className="pull-right">80%</small>
                                        ...
                                        <li className="footer">
                                            <a href="/url_here">View all tasks</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li className="dropdown user user-menu">
                                    <a href="/url_here" className="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <span className="hidden-xs">Admin Renz</span>
                                    </a>
                                    <ul className="dropdown-menu">
                                        {/* User image */}
                                ...
                                <small>Member since Nov. 2012</small>
                                        ...
                                        <li className="user-body">
                                            <div className="row">
                                                <div className="col-xs-4 text-center">
                                                    <a href="/url_here">Followers</a>
                                                </div>
                                                <div className="col-xs-4 text-center">
                                                    <a href="/url_here">Sales</a>
                                                </div>
                                                <div className="col-xs-4 text-center">
                                                    <a href="/url_here">Friends</a>
                                                </div>
                                            </div>
                                            {/* /.row */}
                                        </li>
                                        ...
                                        <li className="user-footer">
                                            <div className="pull-left">
                                                <a href="/url_here" className="btn btn-default btn-flat">Profile</a>
                                            </div>
                                            <div className="pull-right">
                                                <a href="/url_here" className="btn btn-default btn-flat">Sign out</a>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    <a href="/url_here" data-toggle="control-sidebar"><i className="fa fa-gears" /></a>
                                </li>
                            </ul>
                        </div>
                    </nav>
